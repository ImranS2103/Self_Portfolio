                ...
                <div className="container">
                    ...
                    <div className="col-xl-5 col-lg-6">
                        <div className="project-content wow fadeInRight delay-0-2s">
                            ...
                            <a href="project-details.html" className="details-btn"><i className="far fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div> */}
                    <div className="row align-items-center pb-25">
                        ...
                        <div className="col-xl-5 col-lg-6 ms-auto">
                            <div className="project-content wow fadeInRight delay-0-2s">
                                ...
                                <h2><a href="project-details.html">E-Learning Platform</a></h2>
                    ...
                    <div className="row align-items-center pb-25">
                        ...
                        <div className="col-xl-5 col-lg-6">
                            <div className="project-content wow fadeInRight delay-0-2s">
                                <span className="sub-title">Front End Development</span>
                                <h2><a href="project-details.html">Social Foundatation Website</a></h2>
                    ...
                    <div className="row align-items-center pb-25">
                        ...
                        <div className="col-xl-5 col-lg-6 ms-auto">
                            <div className="project-content wow fadeInRight delay-0-2s">
                                <span className="sub-title">Front End Development</span>
                                <h2><a href="project-details.html">Document Printing</a></h2>
                    ...
                    <div className="project-btn text-center wow fadeInUp delay-0-2s">
                        <a href="projects.html" className="theme-btn">View More Projects <i className="far fa-angle-right"></i></a>
                    </div>
                </div>
